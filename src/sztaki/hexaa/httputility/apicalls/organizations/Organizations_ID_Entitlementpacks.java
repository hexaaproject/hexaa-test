 ...
 * @author Bana Tibor
 */
public class Organizations_ID_Entitlementpacks extends HttpUtilityBasicCall {

    public Organizations_ID_Entitlementpacks() {
        super();
        this.setPath(ServerConstants.ApiCalls.ORGANIZATIONS_ID_ENTITLEMENTPACKS);
