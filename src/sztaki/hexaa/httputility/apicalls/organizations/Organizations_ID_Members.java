 ...
 * @author Bana Tibor
 */
public class Organizations_ID_Members extends HttpUtilityBasicCall {

    public Organizations_ID_Members() {
        super();
        this.setPath(ServerConstants.ApiCalls.ORGANIZATIONS_ID_MEMBERS);
