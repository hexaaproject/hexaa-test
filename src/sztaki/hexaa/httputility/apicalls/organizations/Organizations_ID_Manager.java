 ...
 * @author Bana Tibor
 */
public class Organizations_ID_Manager extends HttpUtilityBasicCall {

    public Organizations_ID_Manager() {
        super();
        this.setPath(ServerConstants.ApiCalls.ORGANIZATIONS_ID_MANAGER);
