 ...
 * @author Bana Tibor
 */
public class Organizations_ID_Manager_PID extends HttpUtilityBasicCall {

    public Organizations_ID_Manager_PID() {
        super();
        this.setPath(ServerConstants.ApiCalls.ORGANIZATIONS_ID_MANAGER_PID);
