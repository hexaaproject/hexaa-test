 ...
 * @author Bana Tibor
 */
public class Organizations_ID_Entitlementpacks_EPID extends HttpUtilityBasicCall {

    public Organizations_ID_Entitlementpacks_EPID() {
        super();
        this.setPath(ServerConstants.ApiCalls.ORGANIZATIONS_ID_ENTITLEMENTPACKS_EPID);
