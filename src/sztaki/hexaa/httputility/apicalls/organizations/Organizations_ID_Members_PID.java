 ...
 * @author Bana Tibor
 */
public class Organizations_ID_Members_PID extends HttpUtilityBasicCall {

    public Organizations_ID_Members_PID() {
        super();
        this.setPath(ServerConstants.ApiCalls.ORGANIZATIONS_ID_MEMBERS_PID);
