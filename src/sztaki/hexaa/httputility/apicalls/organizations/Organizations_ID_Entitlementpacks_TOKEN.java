 ...
 * @author Bana Tibor
 */
public class Organizations_ID_Entitlementpacks_TOKEN extends HttpUtilityBasicCall {

    public Organizations_ID_Entitlementpacks_TOKEN() {
        super();
        this.setPath(ServerConstants.ApiCalls.ORGANIZATIONS_ID_ENTITLEMENTPACKS_TOKEN);
