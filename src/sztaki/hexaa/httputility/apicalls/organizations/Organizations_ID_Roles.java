 ...
 * @author Bana Tibor
 */
public class Organizations_ID_Roles extends HttpUtilityBasicCall {

    public Organizations_ID_Roles() {
        super();
        this.setPath(ServerConstants.ApiCalls.ORGANIZATIONS_ID_ROLES);
