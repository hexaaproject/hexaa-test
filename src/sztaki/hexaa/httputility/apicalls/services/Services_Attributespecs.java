 ...
 * @author Bana Tibor
 */
public class Services_Attributespecs extends HttpUtilityBasicCall {

    public Services_Attributespecs() {
        super();
        this.setPath(ServerConstants.ApiCalls.SERVICES_ATTRIBUTESPECS);
