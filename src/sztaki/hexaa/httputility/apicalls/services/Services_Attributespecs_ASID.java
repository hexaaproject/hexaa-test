 ...
 * @author Bana Tibor
 */
public class Services_Attributespecs_ASID extends HttpUtilityBasicCall {

    public Services_Attributespecs_ASID() {
        super();
        this.setPath(ServerConstants.ApiCalls.SERVICES_ATTRIBUTESPECS_ASID);
