 ...
 * @author Bana Tibor
 */
public class Principal_Attributespecs extends HttpUtilityBasicCall {

    public Principal_Attributespecs() {
        super();
        this.setPath(ServerConstants.ApiCalls.PRINCIPAL_ATTRIBUTESPECS);
