...
/**
 * TestSuite for the Organizations related test cases, runs them all and does
 * the starting and finishing utility jobs inherited from BasicTestSuite.
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({ OrganizationPutPatchTest.class,
		OrganizationDeleteTest.class, OrganizationPostTest.class,
		OrganizationGetTest.class, OrganizationsManagersAddTest.class,
		OrganizationsMembersAddTest.class, OrganizationsManagersGetTest.class,
		OrganizationsMembersGetTest.class,
		OrganizationsManagersRemoveTest.class,
		OrganizationsMembersRemoveTest.class, OrganizationsRolesGetTest.class,
