 ...
 */
public class AttributevalueorganizationsServicesPutTest extends NormalTest {
	...
	public static void classInformation() {
		System.out.println("***\t "
				+ AttributevalueorganizationsServicesPutTest.class
						.getSimpleName() + " ***");
	}
	...
	public void testAttributevalueorganizationsPutServices() {
		Utility.Link.serviceToAttributevalueorganizations(attributevalueorganization.getJSONObject(0).getInt("id"), services.getJSONObject(0).getInt("id"));
		...
		try {
			jsonResponse = persistent.getResponseJSONObject(
					...
					BasicCall.REST.GET, null, attributevalueorganization.getJSONObject(0).getInt("id"), services.getJSONObject(0).getInt("id"));
		...
		try {
			service = persistent.getResponseJSONObject(Const.Api.SERVICES_ID,
					BasicCall.REST.GET, null, services.getJSONObject(0).getInt("id"), 0);
		} catch (ResponseTypeMismatchException ex) {
			fail(ex.getFullMessage());
			return;
		}
