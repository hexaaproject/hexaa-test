...
public class SecuritydomainServicesPutTest extends NormalTest {
	...
	public static void setUpClass() {
		...
		if (domains.length() < 1) {
			fail("Utility.Create.securitydomain(\"SecuritydomainServicesPutTest_sd1\", \"alternativeTestMasterKey\", \"This is a security domain to test the capability of posting one.\"); did not succeed");
		}
	}
