...
public class PrincipalsPutPatchTest extends CleanTest {
	...
	public void testPrincipalsPut() {
		...
		persistent.call(Const.Api.PRINCIPALS_ID, BasicCall.REST.PUT, principals
				.getJSONObject(0).toString(), 2, 2);
		...
		try {
			jsonResponse = persistent.getResponseJSONObject(
					Const.Api.PRINCIPALS_ID_ID, BasicCall.REST.GET, null, 2, 2);
