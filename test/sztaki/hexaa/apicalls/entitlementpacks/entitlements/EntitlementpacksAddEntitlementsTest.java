...
public class EntitlementpacksAddEntitlementsTest extends CleanTest {
	...
	public static void setUpClass() {
		...
		Utility.Create.entitlements(1, new String[] { "testEntitlements1",
				"testEntitlements2" });
	...
	public void checkEntitlementInPacks(int[] entitlementIds, int packId) {
		...
		for (int i : entitlementIds) {
			jsonEntitlementArray.put((JSONObject) JSONParser
		...
		jsonResponseArray = (JSONArray) JSONParser.parseJSON(persistent.call(
