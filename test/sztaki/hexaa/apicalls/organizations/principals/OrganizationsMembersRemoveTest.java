 ...
 */
public class OrganizationsMembersRemoveTest extends NormalTest {
	...
	public static void classInformation() {
		System.out
				.println("***\t "
						+ OrganizationsMembersRemoveTest.class.getSimpleName()
						+ " ***");
	}
	...
	public void testOrganizationMemberRemove() {
		Utility.Remove.members(organizations.getJSONObject(0).getInt("id"), principals.getJSONObject(0).getInt("id"));
