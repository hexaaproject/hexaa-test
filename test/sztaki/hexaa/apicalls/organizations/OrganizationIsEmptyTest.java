...
public class OrganizationIsEmptyTest extends IsEmptyTest {
	...
	public static void classInformation() {
		System.out.println("***\t "
				+ OrganizationIsEmptyTest.class.getSimpleName() + " ***");
	}
	...
	public void testOrganizationIsEmptyGet() {
		...
		expectingNotFound(
				...
				BasicCall.REST.GET);
		expectingNotFound(Const.Api.ORGANIZATIONS_ID_ENTITLEMENTPACKS,
				BasicCall.REST.GET);
		expectingNotFound(Const.Api.ORGANIZATIONS_ID_ENTITLEMENTS,
				BasicCall.REST.GET);
		expectingNotFound(Const.Api.ORGANIZATIONS_ID_MANAGERS,
				BasicCall.REST.GET);
		expectingNotFound(Const.Api.ORGANIZATIONS_ID_MEMBERS,
				BasicCall.REST.GET);
		expectingNotFound(Const.Api.ORGANIZATIONS_ID_ROLES, BasicCall.REST.GET);
	}
	...
	public void testOrganizationIsEmptyPut() {
		expectingNotFound(Const.Api.ORGANIZATIONS_ID, BasicCall.REST.PUT);
		...
		expectingNotFound(
				...
				BasicCall.REST.PUT);
		expectingNotFound(Const.Api.ORGANIZATIONS_ID_ENTITLEMENTPACKS_TOKEN,
				BasicCall.REST.PUT);
	...
	public void testOrganizationIsEmptyDelete() {
		expectingNotFound(Const.Api.ORGANIZATIONS_ID, BasicCall.REST.DELETE);
		expectingNotFound(Const.Api.ORGANIZATIONS_ID_ENTITLEMENTPACKS_EPID,
	...
	public void testOrganizationIsEmptyPatch() {
		expectingNotFound(Const.Api.ORGANIZATIONS_ID, BasicCall.REST.PATCH);
	}
}
