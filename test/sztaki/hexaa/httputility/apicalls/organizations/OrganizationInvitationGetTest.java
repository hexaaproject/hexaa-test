...
public class OrganizationInvitationGetTest extends CleanTest {
    ...
    public static void classInformation() {
        System.out.println("***\t " + OrganizationInvitationGetTest.class.getSimpleName() + " ***");
    }
    ...
    public static void setUpClass() {
        ...
        for (int i = 0; i < invitations.length(); i++) {
            invitations.getJSONObject(i).put("organization_id", invitations.getJSONObject(i).remove("organization"));
        }
    }
    ...
    public void testOrganizationInvitationGet() {
        ...
        try {
            ...
            Logger.getLogger(OrganizationInvitationGetTest.class.getName()).log(Level.SEVERE, null, ex);
            fail(ex.getFullMessage());
            return;
        }

        try {
            JSONAssert.assertEquals(invitations, jsonResponse, JSONCompareMode.LENIENT);
