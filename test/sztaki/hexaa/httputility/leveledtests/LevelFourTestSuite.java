...
@Suite.SuiteClasses({
    ...
    sztaki.hexaa.httputility.apicalls.services.attributespecs.ServicesAttributespecsSetTest.class,
    ...
    sztaki.hexaa.httputility.apicalls.services.managers.ServicesManagersCountTest.class,
})
